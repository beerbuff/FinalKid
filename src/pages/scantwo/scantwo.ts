...
import { RemindtwoPage } from '../remindtwo/remindtwo';
...
@IonicPage()
@Component({
  selector: 'page-scantwo',
  templateUrl: 'scantwo.html',
})
export class ScantwoPage {
  scanFormat: string;
  card_id: any;
  studentArray = [];
  term: any;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ScantwoPage');
  }
  ...
  remind() {
    this.navCtrl.push(RemindtwoPage)
  }
