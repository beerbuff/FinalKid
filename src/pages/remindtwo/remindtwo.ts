...
@IonicPage()
@Component({
  selector: 'page-remindtwo',
  templateUrl: 'remindtwo.html',
})
export class RemindtwoPage {
  term = '';
  teacher = '';
  student = [];
  qrId = [];
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad RemindtwoPage');
  }

  
  loadstudentcheckData(card_id) {
    let url = 'http://192.168.43.75/servicephp/getremind2.php?card_id='+card_id;
